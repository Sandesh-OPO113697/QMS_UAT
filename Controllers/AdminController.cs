...
namespace QMS.Controllers
{
    public class AdminController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetMonitoring([FromBody] DashboardFilterModel model)
        {
            DataTable dt = await _admin.GetMonitoringDashboard(model);
        ...
        [HttpPost]
        public async Task<IActionResult> GetAllAgnetCQPerformance([FromBody] DashboardFilterModel model)
        {
            DataTable dt = await _admin.GetAllAgnetCQPerformance(model);
